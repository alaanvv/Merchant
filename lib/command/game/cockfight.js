const { getCoins, countItem, removeItem, addCoins, removeCoins, resolveCoins } = require('../../util')
...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    const winRate = (bot.cocks[String(message.author.id)] || (bot.rules.COCKFIGHT_START_WIN_RATE + armor / 100))
